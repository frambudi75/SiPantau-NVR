...
if command -v crontab > /dev/null 2>&1; then
    echo "*/2 * * * * php /var/www/html/api/watchdog.php >> /var/www/html/ffmpeg_error.log 2>&1" | crontab -
...
(
    ...
    php /var/www/html/api/watchdog.php >> /var/www/html/ffmpeg_error.log 2>&1 || true
